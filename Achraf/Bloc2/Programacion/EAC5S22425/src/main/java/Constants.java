public class Constants {
    ...
    public static final String MESSAGE_DEFAULT_ASK_LONG = "Introdueixi la longitud on es troba el supermercat";
    public static final String MESSAGE_DEFAULT_ASK_LATITUD = "Introdueixi la latitud on es troba el supermercat";
